...
PROTOBUF_CONSTEXPR PrefixesInfo::PrefixesInfo(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::MessageLite(PrefixesInfo_class_data_.base()),
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::MessageLite(LanguageCodeInfo_class_data_.base()),
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::MessageLite(),
#endif  // PROTOBUF_CUSTOM_VTABLE
      _impl_(::_pbi::ConstantInitialized()) {
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::MessageLite(CountryCodeInfo_class_data_.base()),
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::MessageLite(),
#endif  // PROTOBUF_CUSTOM_VTABLE
      _impl_(::_pbi::ConstantInitialized()) {
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::MessageLite(CountriesInfo_class_data_.base()),
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::MessageLite(),
#endif  // PROTOBUF_CUSTOM_VTABLE
      _impl_(::_pbi::ConstantInitialized()) {
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::MessageLite(GeocodingInfo_class_data_.base()),
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::MessageLite(),
#endif  // PROTOBUF_CUSTOM_VTABLE
      _impl_(::_pbi::ConstantInitialized()) {
...
GeocodingInfo::GeocodingInfo(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::MessageLite(arena, GeocodingInfo_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
PROTOBUF_NDEBUG_INLINE GeocodingInfo::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::i18n::phonenumbers::GeocodingInfo& from_msg)
...
GeocodingInfo::GeocodingInfo(
  ...
  _impl_.language_code_info_ = (CheckHasBit(cached_has_bits, 0x00000010U))
                ? ::google::protobuf::MessageLite::CopyConstruct(arena, *from._impl_.language_code_info_)
                : nullptr;
  _impl_.country_code_info_ = (CheckHasBit(cached_has_bits, 0x00000020U))
                ? ::google::protobuf::MessageLite::CopyConstruct(arena, *from._impl_.country_code_info_)
                : nullptr;
...
inline void GeocodingInfo::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
...
inline void* PROTOBUF_NONNULL GeocodingInfo::PlacementNew_(
...
constexpr auto GeocodingInfo::InternalGenerateClassData_() {
...
const ::google::protobuf::internal::ClassDataLite<32> GeocodingInfo_class_data_ =
    GeocodingInfo::InternalGenerateClassData_();

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
GeocodingInfo::GetClassData() const {
  return GeocodingInfo_class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<3, 6, 4, 0, 2>
GeocodingInfo::_table_ = {
  {
    ...
    GeocodingInfo_class_data_.base(),
    ...
    // repeated .i18n.phonenumbers.PrefixesInfo prefixes_info = 1;
    {PROTOBUF_FIELD_OFFSET(GeocodingInfo, _impl_.prefixes_info_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
    // repeated string languages = 2;
    {PROTOBUF_FIELD_OFFSET(GeocodingInfo, _impl_.languages_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcRepeated | ::_fl::kBytes | ::_fl::kRepSString)},
    // required .i18n.phonenumbers.LanguageCodeInfo language_code_info = 3;
    {PROTOBUF_FIELD_OFFSET(GeocodingInfo, _impl_.language_code_info_), _Internal::kHasBitsOffset + 4, 1, (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
    // repeated .i18n.phonenumbers.CountriesInfo countries_info = 4;
    {PROTOBUF_FIELD_OFFSET(GeocodingInfo, _impl_.countries_info_), _Internal::kHasBitsOffset + 2, 2, (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
    // repeated int32 countries = 5;
    {PROTOBUF_FIELD_OFFSET(GeocodingInfo, _impl_.countries_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcRepeated | ::_fl::kInt32)},
    // required .i18n.phonenumbers.CountryCodeInfo country_code_info = 6;
    {PROTOBUF_FIELD_OFFSET(GeocodingInfo, _impl_.country_code_info_), _Internal::kHasBitsOffset + 5, 3, (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
  }},
  {{
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL GeocodingInfo::_InternalSerialize(
...
void GeocodingInfo::MergeImpl(::google::protobuf::MessageLite& to_msg,
                            const ::google::protobuf::MessageLite& from_msg) {
   auto* const _this =
      static_cast<GeocodingInfo*>(&to_msg);
  ...
  if (BatchCheckHasBit(cached_has_bits, 0x0000003fU)) {
    if (CheckHasBitForRepeated(cached_has_bits, 0x00000001U)) {
      _this->_internal_mutable_prefixes_info()->InternalMergeFromWithArena(
    ...
    if (CheckHasBitForRepeated(cached_has_bits, 0x00000004U)) {
      _this->_internal_mutable_countries_info()->InternalMergeFromWithArena(
          ::google::protobuf::MessageLite::internal_visibility(), arena,
    ...
    if (CheckHasBit(cached_has_bits, 0x00000010U)) {
      ...
      if (_this->_impl_.language_code_info_ == nullptr) {
        _this->_impl_.language_code_info_ = ::google::protobuf::MessageLite::CopyConstruct(arena, *from._impl_.language_code_info_);
      } else {
    ...
    if (CheckHasBit(cached_has_bits, 0x00000020U)) {
      ...
      if (_this->_impl_.country_code_info_ == nullptr) {
        _this->_impl_.country_code_info_ = ::google::protobuf::MessageLite::CopyConstruct(arena, *from._impl_.country_code_info_);
      } else {
...
void GeocodingInfo::InternalSwap(GeocodingInfo* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;
...
PrefixesInfo::PrefixesInfo(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::MessageLite(arena, PrefixesInfo_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::MessageLite(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
...
PROTOBUF_NDEBUG_INLINE PrefixesInfo::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::i18n::phonenumbers::PrefixesInfo& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
...
inline void PrefixesInfo::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
  new (&_impl_) Impl_(internal_visibility(), arena);
  ::memset(reinterpret_cast<char*>(&_impl_) +
               offsetof(Impl_, prefixes_num_),
           0,
...
inline void* PROTOBUF_NONNULL PrefixesInfo::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
...
constexpr auto PrefixesInfo::InternalGenerateClassData_() {
...
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataLite<31> PrefixesInfo_class_data_ =
    PrefixesInfo::InternalGenerateClassData_();

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
PrefixesInfo::GetClassData() const {
  return PrefixesInfo_class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<3, 5, 0, 0, 2>
PrefixesInfo::_table_ = {
  {
    ...
    // required int32 prefixes_num = 1;
    {PROTOBUF_FIELD_OFFSET(PrefixesInfo, _impl_.prefixes_num_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // repeated int32 prefixes = 2;
    {PROTOBUF_FIELD_OFFSET(PrefixesInfo, _impl_.prefixes_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcRepeated | ::_fl::kInt32)},
    // repeated string descriptions = 3;
    {PROTOBUF_FIELD_OFFSET(PrefixesInfo, _impl_.descriptions_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcRepeated | ::_fl::kBytes | ::_fl::kRepSString)},
    // required int32 lengths_num = 4;
    {PROTOBUF_FIELD_OFFSET(PrefixesInfo, _impl_.lengths_num_), _Internal::kHasBitsOffset + 4, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // repeated int32 lengths = 5;
    {PROTOBUF_FIELD_OFFSET(PrefixesInfo, _impl_.lengths_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcRepeated | ::_fl::kInt32)},
  }},
  // no aux_entries
  {{
  }},
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL PrefixesInfo::_InternalSerialize(
    const ::google::protobuf::MessageLite& base, ::uint8_t* PROTOBUF_NONNULL target,
    ::google::protobuf::io::EpsCopyOutputStream* PROTOBUF_NONNULL stream) {
...
void PrefixesInfo::MergeImpl(::google::protobuf::MessageLite& to_msg,
                            const ::google::protobuf::MessageLite& from_msg) {
   auto* const _this =
      static_cast<PrefixesInfo*>(&to_msg);
...
void PrefixesInfo::InternalSwap(PrefixesInfo* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
...
LanguageCodeInfo::LanguageCodeInfo(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::MessageLite(arena, LanguageCodeInfo_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::MessageLite(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
...
PROTOBUF_NDEBUG_INLINE LanguageCodeInfo::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::i18n::phonenumbers::LanguageCodeInfo& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
...
inline void LanguageCodeInfo::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
  new (&_impl_) Impl_(internal_visibility(), arena);
...
inline void* PROTOBUF_NONNULL LanguageCodeInfo::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
...
constexpr auto LanguageCodeInfo::InternalGenerateClassData_() {
...
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataLite<35> LanguageCodeInfo_class_data_ =
    LanguageCodeInfo::InternalGenerateClassData_();

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
LanguageCodeInfo::GetClassData() const {
  return LanguageCodeInfo_class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<1, 2, 0, 0, 2>
LanguageCodeInfo::_table_ = {
  {
    ...
    0,  // num_aux_entries
    offsetof(decltype(_table_), field_names),  // no aux_entries
    LanguageCodeInfo_class_data_.base(),
    nullptr,  // post_loop_handler
    ::_pbi::TcParser::GenericFallbackLite,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ...
    {::_pbi::TcParser::FastV32S1,
     {8, 1, 0,
      PROTOBUF_FIELD_OFFSET(LanguageCodeInfo, _impl_.language_codes_num_)}},
  }}, {{
    65535, 65535
  }}, {{
    // required int32 language_codes_num = 1;
    {PROTOBUF_FIELD_OFFSET(LanguageCodeInfo, _impl_.language_codes_num_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // repeated string language_codes = 2;
    {PROTOBUF_FIELD_OFFSET(LanguageCodeInfo, _impl_.language_codes_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcRepeated | ::_fl::kBytes | ::_fl::kRepSString)},
  }},
  // no aux_entries
  {{
  }},
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL LanguageCodeInfo::_InternalSerialize(
    const ::google::protobuf::MessageLite& base, ::uint8_t* PROTOBUF_NONNULL target,
    ::google::protobuf::io::EpsCopyOutputStream* PROTOBUF_NONNULL stream) {
...
void LanguageCodeInfo::MergeImpl(::google::protobuf::MessageLite& to_msg,
                            const ::google::protobuf::MessageLite& from_msg) {
   auto* const _this =
      static_cast<LanguageCodeInfo*>(&to_msg);
  ...
  if (BatchCheckHasBit(cached_has_bits, 0x00000003U)) {
    if (CheckHasBitForRepeated(cached_has_bits, 0x00000001U)) {
      _this->_internal_mutable_language_codes()->InternalMergeFromWithArena(
          ::google::protobuf::MessageLite::internal_visibility(), arena,
          from._internal_language_codes());
    }
    if (CheckHasBit(cached_has_bits, 0x00000002U)) {
...
void LanguageCodeInfo::InternalSwap(LanguageCodeInfo* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
...
CountriesInfo::CountriesInfo(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::MessageLite(arena, CountriesInfo_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::MessageLite(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
...
PROTOBUF_NDEBUG_INLINE CountriesInfo::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::i18n::phonenumbers::CountriesInfo& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
...
inline void CountriesInfo::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
  new (&_impl_) Impl_(internal_visibility(), arena);
...
inline void* PROTOBUF_NONNULL CountriesInfo::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
...
constexpr auto CountriesInfo::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataLite<32>{
      {
...
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataLite<32> CountriesInfo_class_data_ =
    CountriesInfo::InternalGenerateClassData_();

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
CountriesInfo::GetClassData() const {
  return CountriesInfo_class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<1, 2, 0, 0, 2>
CountriesInfo::_table_ = {
  {
    ...
    0,  // num_aux_entries
    offsetof(decltype(_table_), field_names),  // no aux_entries
    CountriesInfo_class_data_.base(),
    nullptr,  // post_loop_handler
    ::_pbi::TcParser::GenericFallbackLite,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ...
    {::_pbi::TcParser::FastV32S1,
     {8, 1, 0,
      PROTOBUF_FIELD_OFFSET(CountriesInfo, _impl_.country_languages_num_)}},
  }}, {{
    65535, 65535
  }}, {{
    // required int32 country_languages_num = 1;
    {PROTOBUF_FIELD_OFFSET(CountriesInfo, _impl_.country_languages_num_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // repeated string country_languages = 2;
    {PROTOBUF_FIELD_OFFSET(CountriesInfo, _impl_.country_languages_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcRepeated | ::_fl::kBytes | ::_fl::kRepSString)},
  }},
  // no aux_entries
  {{
  }},
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL CountriesInfo::_InternalSerialize(
    const ::google::protobuf::MessageLite& base, ::uint8_t* PROTOBUF_NONNULL target,
    ::google::protobuf::io::EpsCopyOutputStream* PROTOBUF_NONNULL stream) {
...
void CountriesInfo::MergeImpl(::google::protobuf::MessageLite& to_msg,
                            const ::google::protobuf::MessageLite& from_msg) {
   auto* const _this =
      static_cast<CountriesInfo*>(&to_msg);
  ...
  if (BatchCheckHasBit(cached_has_bits, 0x00000003U)) {
    if (CheckHasBitForRepeated(cached_has_bits, 0x00000001U)) {
      _this->_internal_mutable_country_languages()->InternalMergeFromWithArena(
          ::google::protobuf::MessageLite::internal_visibility(), arena,
          from._internal_country_languages());
    }
    if (CheckHasBit(cached_has_bits, 0x00000002U)) {
...
void CountriesInfo::InternalSwap(CountriesInfo* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
...
CountryCodeInfo::CountryCodeInfo(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::MessageLite(arena, CountryCodeInfo_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::MessageLite(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
...
PROTOBUF_NDEBUG_INLINE CountryCodeInfo::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::i18n::phonenumbers::CountryCodeInfo& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
...
inline void CountryCodeInfo::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
  new (&_impl_) Impl_(internal_visibility(), arena);
...
inline void* PROTOBUF_NONNULL CountryCodeInfo::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
...
constexpr auto CountryCodeInfo::InternalGenerateClassData_() {
...
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataLite<34> CountryCodeInfo_class_data_ =
    CountryCodeInfo::InternalGenerateClassData_();

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
CountryCodeInfo::GetClassData() const {
  return CountryCodeInfo_class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<1, 2, 0, 0, 2>
CountryCodeInfo::_table_ = {
  {
    ...
    0,  // num_aux_entries
    offsetof(decltype(_table_), field_names),  // no aux_entries
    CountryCodeInfo_class_data_.base(),
    nullptr,  // post_loop_handler
    ::_pbi::TcParser::GenericFallbackLite,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ...
    {::_pbi::TcParser::FastV32S1,
     {8, 1, 0,
      PROTOBUF_FIELD_OFFSET(CountryCodeInfo, _impl_.country_codes_num_)}},
  }}, {{
    65535, 65535
  }}, {{
    // required int32 country_codes_num = 1;
    {PROTOBUF_FIELD_OFFSET(CountryCodeInfo, _impl_.country_codes_num_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // repeated int32 country_codes = 2;
    {PROTOBUF_FIELD_OFFSET(CountryCodeInfo, _impl_.country_codes_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcRepeated | ::_fl::kInt32)},
  }},
  // no aux_entries
  {{
  }},
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL CountryCodeInfo::_InternalSerialize(
    const ::google::protobuf::MessageLite& base, ::uint8_t* PROTOBUF_NONNULL target,
    ::google::protobuf::io::EpsCopyOutputStream* PROTOBUF_NONNULL stream) {
...
void CountryCodeInfo::MergeImpl(::google::protobuf::MessageLite& to_msg,
                            const ::google::protobuf::MessageLite& from_msg) {
   auto* const _this =
      static_cast<CountryCodeInfo*>(&to_msg);
...
void CountryCodeInfo::InternalSwap(CountryCodeInfo* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
